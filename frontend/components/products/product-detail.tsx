  ...
  return (
    <section className="space-y-6">
      <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="soft-panel rounded-[1.6rem] p-6 sm:p-8">
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <h2 className="editorial-title text-5xl leading-[0.94] text-[#111111] sm:text-6xl">{product.name}</h2>
            ...
            <div className="grid gap-4 rounded-[1.2rem] bg-[#f5f5f5] p-5 text-sm text-[#555555] sm:grid-cols-3">
              <div>
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-4 z-40 px-4 lg:hidden">
        <div className="pointer-events-auto mx-auto flex max-w-lg items-center justify-between rounded-full border border-black/8 bg-white/94 px-4 py-3 shadow-[0_28px_60px_-28px_rgba(17,17,17,0.25)] backdrop-blur">
          <div>
